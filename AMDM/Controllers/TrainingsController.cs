...
namespace AMDM.Controllers
{
    public class TrainingsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["TrainingTypeId"] = new SelectList(_context.Set<TrainingType>(), "Id", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,TrainingTypeId,TrainerId,Date,Time,Studio,MaxRegisterTrainees")] Training training)
        {
            ...
            ViewData["TrainingTypeId"] = new SelectList(_context.Set<TrainingType>(), "Id", "Name", training.TrainingTypeId);
            return View(training);
        }
